...
export class UserServiceService {
  ...
  constructor(private http: HttpClient, private httpReq: HttpClient) { }
  ...
  public updateUser(id: number, request): Observable<any> {
    return this.http.put(`http://13.235.242.112:8080/updateUser/${id}`, request);
  }

  // update an existing user by an admin
  public updateAdmin(id: number, request): Observable<any> {
    return this.http.put(`http://13.235.242.112:8080/updateAdmin/${id}`, request);
  }

  // update an registered user
  public update(id: number, request): Observable<any> {
    return this.http.put(`http://13.235.242.112:8080/update/${id}`, request);
  }
  ...
  public delete(id: number): Observable<any> {
    return this.http.delete(`http://13.235.242.112:8080/delete/${id}`);
  }

  // delete a record by username
  public deleteUser(username: string): Observable<any> {
    return this.http.delete(`http://13.235.242.112:8080/deleteLoginUser/${username}`);
  }
